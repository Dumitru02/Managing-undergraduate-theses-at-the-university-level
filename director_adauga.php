...
<link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/4.5.0/css/bootstrap.min.css">
 ...
 <link rel="stylesheet" href="director_aduga.css">
        ...
        <div class="col-sm-6">
            <div class="form-group">
                <div class="input-group date" id="datetimepicker4" data-target-input="nearest">
				 ...
				 <label for="exampleFormControlInput1">Numar de pagini</label>
				 <input name="pages" class="form-control" type="text" placeholder="">
				  
				 <label for="exampleFormControlInput1">Site</label>
				 <input name="website" class="form-control" type="text" placeholder="">
				 
				  
				 <label for="exampleFormControlInput1">Țara</label>
